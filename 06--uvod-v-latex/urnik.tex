...
\begin{itemize}
   ...
   \item Razred \enph{Profesor} vsebuje osebne podatke profesorja (ime in priimek) ter
   ...
   \item Razred \enph{Skupina} predstavlja skupino študentov. Kot podatke torej potrebujemo
   ...
   \item Razred \enph{Predavalnica} nosi podatke o kapaciteti predavalnice, njeno oznako
   ter podatke o zasedenosti, ki so predstavljeni s tabelo.

   \item Razred \enph{Predmet} vsebuje podatke o posameznih predmetih. Kot podatke tega
...
tip (npr. \text{bool v C++}, kjer bi vrednost \textt{true} predstavljala
dosegljivost, textt{false} pa zasedenost.
