    ...
    \begin{columns}
		...
		\begin{tikzpicture}
				...
				% Naloga 3.4.2.: Definirajte točko T', v kateri se začne lok m in narišite lok m z oznako.
				 \pause
				\coordinate (T') at ({-2*\td},{\tt});
				 \draw[grey, thin](T') node[left] {\scriptsize $m$} arc[start angle=60, end angle=-60, radius=2];
				 ...
				 \draw[grey, thin](T'') node[left] {\scriptsize $n$} arc[start angle=120, end angle=240, radius=2];
