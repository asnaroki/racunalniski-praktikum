...
\end{block}
\begin{alertblock}{Opozorilo}   °%alert in block dodatki
...
\begin{frame}{Tudi v predstavitvah lahko pišemo izreke in dokaze}
	...
	\begin{proof}
	   ...
	   \begin{itemize}[<+->]
		  \item Naj bo $p$ \alert<4>{največje} praštevilo.  % <4> samo 4. slide
		  \item Naj bo $q$ produkt števil $1$, $2$, \ldots, $p$.
		  \item Število $q+1$ ni deljivo z nobenim praštevilom, torej je $q+1$ praštevilo.
		  \item To je protislovje, saj je $q+1>p$. \qedhere °%znak za konec ukaza
	   \end{itemize}
	\end{proof}
 \end{frame}
