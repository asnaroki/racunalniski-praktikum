...
\usepackage{url}
\usepackage{graphicx}
\usepackage{amsmath} % Rabimo to in spodaj za izpit si zapomnit. Vse drugo pomoje podano
\usepackage{amsthm}
\usepackage{booktabs}
\usepackage{xcolor}
...
\makeatletter
\newenvironment{Dokaz zreka}[1][]
  {\begin{proof}[Dokaz izreka\@addpunct{.}\ifx\\#1\\\else~#1\fi]
   }{\end{proof}
}
...
% - oznaka: table:mag3
\begin{magic}{3}{Magični kvadrtat reda 3}{table:mag3}
     8 & 1 & 6 \\\hline
     3 & 5 & 7 \\\hline
     4 & 9 & 2 \\\hline
\end{magic}
...
% - oznaka: table:mag5
\begin{magic}{5}{Magični kvadrat reda 5}{mag5}
17 & 24 &  1 &  8 & 15 \\\hline
23 &  5 &  7 & 14 & 16 \\\hline
4 &  6 & 13 & 20 & 22 \\\hline
10 & 12 & 19 & 21 &  3 \\\hline
